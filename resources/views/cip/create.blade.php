...
<div class="container top">
    ...
    <div class="form_utama">
        <form id="form">
            ...
            <div class="mb-3">
                <label for="nomorIdentitasKetua" class="form-label">Nomor Identitas Ketua(KTP/KTM/KTS)</label>
                <div id="middle-height">
            ...
            <div class="mb-3">
                <label for="nomorIdentitasAnggota1" class="form-label">Nomor Identitas Anggota 1(KTP/KTM/KTS)</label>
                <div id="middle-height">
            ...
            <div class="mb-3">
                <label for="nomorIdentitasAnggota2" class="form-label">Nomor Identitas Anggota 2(KTP/KTM/KTS)</label>
                <div id="middle-height">
        ...
        <button type="submit" class="btn btn-primary" onclick="chemistry_innovation()">Submit</button>
    </div>
</div>
